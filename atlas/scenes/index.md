...
layout: atlas_page
title: "Scenes"
permalink: /atlas/scenes/
seo_description: "Atlas pillar covering installations, performances, and scene systems."
---
<section class="atlas-section">
  <div class="container">
    <p class="eyebrow">Atlas pillar</p>
    <h1>Scenes</h1>
    <p>These are installations, performances, and situated studies where what happens in the room matters as much as the media stack. Participation, routing, consent, control, and recovery are treated as visible structure.</p>
    <p class="atlas-diagram-note">This pillar includes both field-tested systems and cautious studies that still need stronger public proof.</p>
  </div>
</section>
...
<section class="atlas-section">
  <div class="container">
    ...
    <ul class="atlas-todo">
      <li><a href="/atlas/methods/consent-forward-systems/">Consent-Forward Systems</a> matters whenever people, cameras, or retention are involved.</li>
