...
- Stage includes a collapsed, read-only **Motion** drawer with the same Active/All/Solo EF behavior and LFO identities but none of Lab's FPS, refresh, or snapshot diagnostics. It records history while closed and pauses canvas animation until opened.
